...
//import com.example.converter.Retrofit.RetrofitBuilder;
//import com.example.converter.Retrofit.RetroInf;
import com.google.gson.JsonObject;

import Retrofit.RetroInf;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] dropDownList = {"PKR", "USD", "EUR", "CAD", "INR"};
        ...
        button.setOnClickListener(new View.OnClickListener());
    {
        ...
        @Override
            public void onClick(View v){
                RetroInf retroInf = RetrofitBuilder.getRetrofitInstance().create(RetroInf.class);
                Call<JsonObject> call = RetroInf.getExchangeCurrency(convertFromDropdown.getSelectedItem().toString());
